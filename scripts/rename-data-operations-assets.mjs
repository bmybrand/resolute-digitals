...
const sectionFiles = [
  ...
  "components/services/ITSupport/herosec.tsx",
  "components/services/ITSupport/Secsec.tsx",
  "components/services/ITSupport/thirdsec.tsx",
  "components/services/ITSupport/forthsec.tsx",
  "components/services/ITSupport/CoreCapabilities.tsx",
  "components/services/ITSupport/data.tsx",
  "components/services/ITSupport/FaqSection.tsx",
...
async function main() {
  ...
  await fs.writeFile(
    path.join(cwd, "public", "assets", "rd-image-data-operations-manifest.json"),
  ...
  if (missing.length) {
    await fs.writeFile(
      path.join(cwd, "public", "assets", "rd-image-data-operations-missing.json"),
