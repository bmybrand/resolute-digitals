...
const sectionFiles = [
  ...
  "components/services/AIDrivenSolutions/herosec.tsx",
  "components/services/AIDrivenSolutions/Secsec.tsx",
  "components/services/AIDrivenSolutions/thirdsec.tsx",
  "components/services/AIDrivenSolutions/forthsec.tsx",
  "components/services/AIDrivenSolutions/CoreCapabilities.tsx",
  "components/services/AIDrivenSolutions/data.tsx",
  "components/services/AIDrivenSolutions/FaqSection.tsx",
...
async function main() {
  ...
  await fs.writeFile(
    path.join(cwd, "public", "assets", "rd-image-ai-driven-manifest.json"),
  ...
  if (missing.length) {
    await fs.writeFile(
      path.join(cwd, "public", "assets", "rd-image-ai-driven-missing.json"),
