...
const sectionFiles = [
  ...
  "components/services/Softwaredev/herosec.tsx",
  "components/services/Softwaredev/Secsec.tsx",
  "components/services/Softwaredev/thirdsec.tsx",
  "components/services/Softwaredev/forthsec.tsx",
  "components/services/Softwaredev/CoreCapabilities.tsx",
  "components/services/Softwaredev/data.tsx",
  "components/services/Softwaredev/FaqSection.tsx",
...
async function main() {
  ...
  await fs.writeFile(
    path.join(cwd, "public", "assets", "rd-image-software-development-manifest.json"),
  ...
  if (missing.length) {
    await fs.writeFile(
      path.join(cwd, "public", "assets", "rd-image-software-development-missing.json"),
