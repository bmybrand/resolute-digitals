...
const sectionFiles = [
  ...
  "components/services/DataResearch/herosec.tsx",
  "components/services/DataResearch/Secsec.tsx",
  "components/services/DataResearch/thirdsec.tsx",
  "components/services/DataResearch/forthsec.tsx",
  "components/services/DataResearch/CoreCapabilities.tsx",
  "components/services/DataResearch/data.tsx",
  "components/services/DataResearch/FaqSection.tsx",
...
async function main() {
  ...
  await fs.writeFile(
    path.join(cwd, "public", "assets", "rd-image-data-research-manifest.json"),
  ...
  if (missing.length) {
    await fs.writeFile(
      path.join(cwd, "public", "assets", "rd-image-data-research-missing.json"),
  ...
  if (failures.length) {
    await fs.writeFile(
      path.join(cwd, "public", "assets", "rd-image-data-research-format-failures.json"),
