...
async function main() {
  ...
  await fs.writeFile(
    path.join(cwd, "public", "assets", "rd-image-casestudy-manifest.json"),
  ...
  if (missing.length) {
    await fs.writeFile(
      path.join(cwd, "public", "assets", "rd-image-casestudy-missing.json"),
  ...
  if (failures.length) {
    await fs.writeFile(
      path.join(cwd, "public", "assets", "rd-image-casestudy-format-failures.json"),
