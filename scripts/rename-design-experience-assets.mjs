...
const sectionFiles = [
  ...
  "components/services/Design-Experience/herosec.tsx",
  "components/services/Design-Experience/Secsec.tsx",
  "components/services/Design-Experience/thirdsec.tsx",
  "components/services/Design-Experience/forthsec.tsx",
  "components/services/Design-Experience/CoreCapabilities.tsx",
  "components/services/Design-Experience/data.tsx",
  "components/services/Design-Experience/FaqSection.tsx",
...
async function main() {
  ...
  await fs.writeFile(
    path.join(cwd, "public", "assets", "rd-image-design-experience-manifest.json"),
  ...
  if (missing.length) {
    await fs.writeFile(
      path.join(cwd, "public", "assets", "rd-image-design-experience-missing.json"),
  ...
  if (failures.length) {
    await fs.writeFile(
      path.join(cwd, "public", "assets", "rd-image-design-experience-format-failures.json"),
