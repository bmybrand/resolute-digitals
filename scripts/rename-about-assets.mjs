...
const sectionFiles = [
  ...
  "components/About/herosec.tsx",
  "components/About/Secondsec.tsx",
  "components/About/Horizontaltimeline.tsx",
  "components/services/servies.tsx",
  "components/About/howworksec.tsx",
  "components/About/workTogether.tsx",
  "components/About/Secondsec copy.tsx",
  "components/About/InfiniteMultiColumnScroll.tsx",
  "components/About/rewiewcards.tsx",
...
async function main() {
  ...
  await fs.writeFile(
    path.join(cwd, "public", "assets", "rd-image-about-manifest.json"),
  ...
  if (missing.length) {
    await fs.writeFile(
      path.join(cwd, "public", "assets", "rd-image-about-missing.json"),
