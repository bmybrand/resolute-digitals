...
const sectionFiles = [
  ...
  "components/OurTeam/herosec.tsx",
  "components/OurTeam/theteam.tsx",
...
async function main() {
  ...
  await fs.writeFile(
    path.join(cwd, "public", "assets", "rd-image-ourteam-manifest.json"),
  ...
  if (missing.length) {
    await fs.writeFile(
      path.join(cwd, "public", "assets", "rd-image-ourteam-missing.json"),
