...
const sectionFiles = [
  ...
  "components/services/PropertyTaxation/herosec.tsx",
  "components/services/PropertyTaxation/Secsec.tsx",
  "components/services/PropertyTaxation/thirdsec.tsx",
  "components/services/PropertyTaxation/forthsec.tsx",
  "components/services/PropertyTaxation/CoreCapabilities.tsx",
  "components/services/PropertyTaxation/data.tsx",
  "components/services/PropertyTaxation/FaqSection.tsx",
...
async function main() {
  ...
  await fs.writeFile(
    path.join(cwd, "public", "assets", "rd-image-property-taxation-manifest.json"),
  ...
  if (missing.length) {
    await fs.writeFile(
      path.join(cwd, "public", "assets", "rd-image-property-taxation-missing.json"),
  ...
  if (failures.length) {
    await fs.writeFile(
      path.join(cwd, "public", "assets", "rd-image-property-taxation-format-failures.json"),
