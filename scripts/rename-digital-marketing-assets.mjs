...
const sectionFiles = [
  ...
  "components/services/DigitalMarketing/herosec.tsx",
  "components/services/DigitalMarketing/Secsec.tsx",
  "components/services/DigitalMarketing/thirdsec.tsx",
  "components/services/DigitalMarketing/forthsec.tsx",
  "components/services/DigitalMarketing/CoreCapabilities.tsx",
  "components/services/DigitalMarketing/data.tsx",
  "components/services/DigitalMarketing/FaqSection.tsx",
...
async function main() {
  ...
  await fs.writeFile(
    path.join(cwd, "public", "assets", "rd-image-digital-marketing-manifest.json"),
  ...
  if (missing.length) {
    await fs.writeFile(
      path.join(cwd, "public", "assets", "rd-image-digital-marketing-missing.json"),
