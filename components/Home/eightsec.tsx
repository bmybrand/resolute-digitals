...
const eightsec = () => {
  const features = [
    { title: "Cutting-Edge\nDevelopment Strategy", image: "/assets/rd-image070.svg" },
    { title: "Data-Driven\nMarketing", image: "/assets/rd-image071.svg" },
    { title: "Seamless Design &\nFunctionality", image: "/assets/rd-image072.svg" },
    { title: "Proven Digital\nExpertise", image: "/assets/rd-image073.svg" },
  ];

  return (
    <div className="flex flex-col  w-full bg-[url('/assets/rd-image074.png')] bg-no-repeat bg-cover bg-center text-center regular justify-center items-center">
      ...
      <div className="min-w-[80%] w-fit lg:min-w-[35%] min-h-17 lg:w-fit rounded-t-4xl bg-[#041222] flex flex-col lg:flex-row items-center px-5 justify-center gap-5">
        ...
        <img src="/assets/rd-image075.svg" alt="hello" className='w-20 lg:w-26' />
      </div>
